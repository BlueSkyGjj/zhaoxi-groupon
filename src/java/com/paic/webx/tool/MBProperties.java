...
public class MBProperties extends java.util.Properties {
				...
				if (line.length() > 0) {
					...
					if ((firstChar != ' ') && (firstChar != '!')) {
						while (continueLine(line)) {
							...
							String loppedLine = line.substring(0,
									line.length() - 1);
						...
						// Skip over one non whitespace key value separators if
						// any
						if (valueIndex < len) {
							if (strictKeyValueSeparators.indexOf(line
								...
								// Skip over white space after other separators
								// if
								// any
							}
						}
